...
{
    internal class NaRuzkuRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/3854-na-rku.html";

        public NaRuzkuRestaurant() : base(RestaurantType.NaRuzku)
        {
