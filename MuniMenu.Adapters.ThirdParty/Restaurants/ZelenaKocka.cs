...
{
    internal class ZelenaKockaRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/3185-zelen-koka.html";

        public ZelenaKockaRestaurant() : base(RestaurantType.ZelenaKocka)
        {
