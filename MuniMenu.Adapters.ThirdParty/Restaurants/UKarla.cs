...
{
    internal class UKarlaRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/6695-u-karla.html";

        public UKarlaRestaurant() : base(RestaurantType.UKarala)
        {
