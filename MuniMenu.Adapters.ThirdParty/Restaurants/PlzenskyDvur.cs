...
{
    internal class PlzenskyDvurRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/6559-bistro-u-mchala.html";

        public PlzenskyDvurRestaurant() : base(RestaurantType.PlzenskyDvur)
        {
