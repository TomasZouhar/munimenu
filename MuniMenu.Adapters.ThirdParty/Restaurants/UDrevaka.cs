...
{
    internal class UDrevakaRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/2752-u-devka-beergrill.html";

        public UDrevakaRestaurant() : base(RestaurantType.UDrevaka)
        {
