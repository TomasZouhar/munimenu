...
{
    internal class BistroMinisteroRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/6694-bistro-ministerio.html";

        public BistroMinisteroRestaurant() : base(RestaurantType.BistroMinistero)
        {
