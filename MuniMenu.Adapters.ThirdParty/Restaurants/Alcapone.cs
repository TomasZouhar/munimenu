...
{
    internal class AlcaponeRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/2609-pizzeria-al-capone.html";

        public AlcaponeRestaurant() : base(RestaurantType.Alcapone)
        {
