...
{
    internal class GardenFoodConceptRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/6361-garden-food-concept.html";

        public GardenFoodConceptRestaurant() : base(RestaurantType.GardenFoodConcept)
        {
