...
{
    internal class TheImmigrantRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/7470-the-immigrant-.html";

        public TheImmigrantRestaurant() : base(RestaurantType.TheImmigrant)
        {
