...
{
    internal class StavbaRestaurant : RestaurantBase
    {
        private readonly HtmlWeb _htmlWeb;

        private string Url => $"https://www.menicka.cz/4954-restaurace-stavba.html";

        public StavbaRestaurant() : base(RestaurantType.Stavba)
        {
